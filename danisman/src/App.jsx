  ...
  return (
    <div className="flex flex-col  min-h-[96vh] sm:w-[96vw] max-w-[1320px] ">
      <div className="md:flex md:flex-row bg-white rounded-[3rem] m-5 p-5 gap-5 border-[#D9E8E7] border-[20px] ">
        <div className="flex rounded-l-[2rem] flex-col basis-1/5 ">
          <Header toggleMenu={toggleMenu} isMenuOpen={isMenuOpen} />
        </div>
        {/* main container */}
        <div className="relative basis-4/5 flex flex-col bg-[url('/src/assets/mapZone.png')] rounded-3xl bg-cover">
          {/* Katman 1 */}
          <div className="flex flex-col flex-grow rounded-3xl items-center p-5">
            <div className="flex ">
              <div className="hidden sm:block">
                <Harita />
              </div>
              <div>
                <div className="block sm:hidden "><SehirListesi /></div>
          ...
          {/* Katman 2 */}
          <div className="w-full flex h-full items-end justify-between p-5" style={{ "position": "absolute" }}>
