...
const Hatay = () => {
  ...
  return (
    <div className="flex flex-col   w-[2ß5vw] my-6  mx-8  pl-2 bg-slate-100 border rounded-3xl border-solid border-gray-50 pr-2 shadow-2xl dark:bg-cyan-900 max-w-fit ">
      <div className="flex ">
        <button
      ...
      <div className="bg-slate-100 flex-1 mt-3  mb-10 w-[24vw] h-auto  text-left border  border-solid   border-gray-200 rounded-lg text-gray-700">
        <>
          <p className="ml-2">
