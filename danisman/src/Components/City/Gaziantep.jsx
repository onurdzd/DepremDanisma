...
const Gaziantep = () => {
  ...
  return (
    <div className="flex flex-col  x w-[25vw] my-6  mx-8  pl-2 bg-slate-100 border rounded-3xl border-solid border-gray-50 pr-2 shadow-2xl dark:bg-cyan-900 max-w-fit ">
      <div className="flex ">
        <button
        ...
        <p className="  pt-7 pl-3 basis-3/5 inline-block text-xl text-slate-200">
          GAZİANTEP
        </p>
      </div>
      ...
      <div className="bg-slate-100 mt-3 flex-1  mb-10 w- w-[24vw] h-auto  text-left border  border-solid   border-gray-200 rounded-lg text-gray-700">
        <>
          <p className="ml-2">
