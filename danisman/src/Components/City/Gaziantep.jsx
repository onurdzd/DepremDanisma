...
const Gaziantep = () => {
  ...
  return (
    <div className="flex flex-col  x w-[45vw] my-6  mx-8  pl-2 bg-slate-100 border rounded-3xl border-solid border-gray-50 pr-2 shadow-2xl dark:bg-cyan-900 max-w-fit ">
      <div className="flex ">
        <button
