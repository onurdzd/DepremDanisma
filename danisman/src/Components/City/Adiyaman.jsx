...
const Adıyaman = () => {
  ...
  return (
    <div className="flex flex-col  w-[25vw] my-6   mx-8  pl-2 bg-slate-100 border rounded-3xl border-solid border-gray-50 pr-2 shadow-2xl dark:bg-cyan-900 max-w-fit ">
      ...
      <div className="bg-slate-100 w-[24vw] flex-1  h-auto  text-left border  border-solid   border-gray-200 rounded-lg text-gray-700">
        <p className="ml-2 font-medium">Ulaşılan Kişi Sayısı</p>
      </div>
      <div className="bg-slate-100 mt-3 mb-10 flex-1  w-[24vw] h-auto  text-left border  border-solid   border-gray-200 rounded-lg text-gray-700">
        <>
          <p className="ml-2">
