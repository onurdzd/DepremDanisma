          ...
          <div className="container flex flex-col flex-1 px-5 py-6 mx-auto">
            <div className="flex-1 lg:flex lg:items-center  lg:-mx-1">
              <div className="mt-24  lg:w-1/2 lg:mx-1">
                <div className="w-full px-16 py-5 mx-auto overflow-hidden bg-white shadow-2xl rounded-xl dark:bg-gray-800 lg:max-w-xl">
                  ...
                  <form className="mt-3">
                    ...
                    <div className="flex-1 mt-3">
                      ...
                      <input
                        type="tel"
                        placeholder=""
                        className="block w-full px-5 py-3 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring"
                      />
                    </div>
